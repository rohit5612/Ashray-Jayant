...
export default function ScrollToTopButton() {
  ...
  return (
    <button
      ...
      className={`fixed right-6 bottom-6 z-50 flex h-12 w-12 items-center justify-center rounded-full border border-border bg-bg-elevated text-text-primary shadow-lg transition-all duration-300 hover:border-accent-cyan/40 hover:text-accent-cyan hover:shadow-xl focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent-cyan ${
        visible
